...
class _FakeRecordWithActivitySettings_0 extends _i1.SmartFake
  ...
  _FakeRecordWithActivitySettings_0(Object parent, Invocation parentInvocation)
...
class MockActivityLocalDataSource extends _i1.Mock
  ...
  _i4.Future<List<_i2.RecordWithActivitySettings>> getRecords(
      ...
      (super.noSuchMethod(
          ...
          returnValue: _i4.Future<List<_i2.RecordWithActivitySettings>>.value(
              <_i2.RecordWithActivitySettings>[])) as _i4
          .Future<List<_i2.RecordWithActivitySettings>>);
  @override
  _i4.Future<_i2.RecordWithActivitySettings> createRecord(
          {String? activityName, int? startTime, int? endTime}) =>
      (super.noSuchMethod(Invocation.method(#createRecord, [], {#activityName: activityName, #startTime: startTime, #endTime: endTime}),
  ...
  _i4.Future<void> updateRecordTime(
          {int? idRecord, int? startTime, int? endTime}) =>
      (super.noSuchMethod(
  ...
  _i4.Future<_i2.RecordWithActivitySettings> updateRecordSettings(
          {int? idRecord, String? activityName}) =>
      (super
          .noSuchMethod(Invocation.method(#updateRecordSettings, [], {#idRecord: idRecord, #activityName: activityName}),
              returnValue: _i4.Future<_i2.RecordWithActivitySettings>.value(
                  _FakeRecordWithActivitySettings_0(
                      this,
  ...
  _i4.Future<_i2.DriftActivityModel> createActivity(
      ...
      (super.noSuchMethod(Invocation.method(#createActivity, [name, colorHex]),
          ...
          as _i4.Future<_i2.DriftActivityModel>);
  @override
  _i4.Future<void> updateRecordEmoji(int? idRecord, String? emoji) =>
      (super.noSuchMethod(
              Invocation.method(#updateRecordEmoji, [idRecord, emoji]),
              returnValue: _i4.Future<void>.value(),
              returnValueForMissingStub: _i4.Future<void>.value())
          as _i4.Future<void>);
}
