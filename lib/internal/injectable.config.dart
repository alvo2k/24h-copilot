...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i19.RecommendedActivitiesUsecase>(
        () => _i19.RecommendedActivitiesUsecase(gh<_i5.ActivityRepository>()));
    gh.lazySingleton<_i20.SwitchActivitiesUsecase>(
        () => _i20.SwitchActivitiesUsecase(gh<_i5.ActivityRepository>()));
    gh.lazySingleton<_i21.UpdateActivitySettingsUsecase>(() =>
        _i21.UpdateActivitySettingsUsecase(
            gh<_i7.ActivitySettingsRepository>()));
    gh.factory<_i22.ActivitiesBloc>(() => _i22.ActivitiesBloc(
          loadActivitiesUsecase: gh<_i23.LoadActivitiesUsecase>(),
          switchActivityUsecase: gh<_i23.SwitchActivitiesUsecase>(),
          addEmojiUsecase: gh<_i23.AddEmojiUsecase>(),
          editNameUsecase: gh<_i23.EditNameUsecase>(),
          editRecordsUsecase: gh<_i23.EditRecordsUsecase>(),
          recommendedActivitiesUsecase: gh<_i19.RecommendedActivitiesUsecase>(),
        ));
    return this;
  }
}
