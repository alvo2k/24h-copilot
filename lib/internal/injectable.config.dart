...
import 'package:copilot/core/common/data/datasources/activity_local_data_source.dart'
    as _i10;
import 'package:copilot/core/notification_controller.dart' as _i18;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i14.EditNameUsecase>(
        () => _i14.EditNameUsecase(gh<_i8.ActivityRepository>()));
    gh.lazySingleton<_i15.EditRecordsUsecase>(
        () => _i15.EditRecordsUsecase(gh<_i8.ActivityRepository>()));
    gh.lazySingleton<_i16.LoadActivitiesSettingsUsecase>(() =>
        _i16.LoadActivitiesSettingsUsecase(
            gh<_i11.ActivitySettingsRepository>()));
    gh.lazySingleton<_i17.LoadActivitiesUsecase>(
        () => _i17.LoadActivitiesUsecase(gh<_i8.ActivityRepository>()));
    gh.singleton<_i18.NotificationController>(_i18.NotificationController());
    gh.lazySingleton<_i19.PieChartDataRepository>(() =>
        _i20.PieChartDataRepositoryImpl(gh<_i10.ActivityLocalDataSource>()));
    gh.lazySingleton<_i21.PieChartDataUsecase>(
        () => _i21.PieChartDataUsecase(gh<_i19.PieChartDataRepository>()));
    gh.lazySingleton<_i22.RecommendedActivitiesUsecase>(
        () => _i22.RecommendedActivitiesUsecase(gh<_i8.ActivityRepository>()));
    gh.lazySingleton<_i23.SwitchActivitiesUsecase>(
        () => _i23.SwitchActivitiesUsecase(gh<_i8.ActivityRepository>()));
    gh.lazySingleton<_i24.UpdateActivitySettingsUsecase>(() =>
        _i24.UpdateActivitySettingsUsecase(
            gh<_i11.ActivitySettingsRepository>()));
    gh.factory<_i25.ActivitiesBloc>(() => _i25.ActivitiesBloc(
          ...
          recommendedActivitiesUsecase: gh<_i22.RecommendedActivitiesUsecase>(),
        ));
    return this;
  }
}
